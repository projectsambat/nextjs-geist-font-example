...
<div class="container mx-auto p-4 max-w-4xl">
    <h1 class="text-2xl font-bold mb-6">Edit Booking Greendoors</h1>
    ...
    <form action="{{ route('greendoors.update', $booking->id) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="pt-4">
            ...
            <a href="{{ route('greendoors.index') }}" class="ml-4 text-gray-600 hover:underline">Batal</a>
        </div>
    </form>
</div>
@endsection
