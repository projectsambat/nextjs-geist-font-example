...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Daftar Booking Greendoors</h1>
    ...
    <a href="{{ route('greendoors.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Tambah Booking</a>
    ...
    <table class="min-w-full bg-white border border-gray-200">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2 px-4 border-b">
                    <a href="{{ route('greendoors.edit', $booking->id) }}" class="text-blue-600 hover:underline mr-2">Edit</a>
                    <form action="{{ route('greendoors.destroy', $booking->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                        @csrf
                        @method('DELETE')
